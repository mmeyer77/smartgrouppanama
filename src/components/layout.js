...
import smartSVG from "../images/smart-svg1.svg"
import heroImg from "../images/hero.png";
import smartLogo from "../images/LOGO.svg";
...
function Layout({ children }) {
  ...
  return (
    ...
    <StaticQuery
      ...
      render={data => (
        ...
        <body className="leading-normal tracking-normal gradient text-black">
  ...
  <div class="md:hidden flex items-center">
	<button id="mobileb" class="outline-none mobile-menu-button z-50" onClick={() => handleToggle()}>
    <svg 
    ...
    >
        <path d="M4 6h16M4 12h16M4 18h16"></path>
              ...
              <ul class="">
                  <li class="active"><a href="index.html" class="block text-lg px-5  py-4  hover:bg-green-500 font-semibold" onClick={() => closeMenu()}>INICIO</a></li>
                  <li><a href="#servicios" class="block text-lg px-5  py-4 hover:bg-green-500 transition duration-300" onClick={() => closeMenu()}>SERVICIOS</a></li>
                  <li><a href="#about" class="block text-lg px-5  py-4 hover:bg-green-500 transition duration-300" onClick={() => closeMenu()}>PAQUETES</a></li>
                  <li><a href="#contact" class="block text-lg px-5  py-4 hover:bg-green-500 transition duration-300" onClick={() => closeMenu()}>QUIENES SOMOS</a></li>
              </ul>
          </div>
            </nav>
            ...
            <div className="2xl:pt-8">
              ...
              <div className="container px-3 mx-auto flex flex-wrap flex-col-reverse md:flex-row items-center">
                ...
                <div className="md:ml-12 -my-44 flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left z-20">
                  
                  <h1 className="text-4xl      font-bold leading-none text-white xs:mt-3">TU SEGURIDAD ES PRIMERO</h1>
                  <p className="leading-none text-xl     xs:mb-0 mt-2 mb-2 text-white">
                    {data.site.siteMetadata.title} tiene lo que necesitas para que te mantengas protegido 24/7. Contáctanos y prueba nuestras soluciones profesionales de seguridad.
                    
                  </p>
                  {/* BOTON SOLICITA COTIZACION */}
                  <button type="submit" className="mx-auto lg:mx-0 hover:underline bg-white text-green-800     font-bold rounded-full xs:my-6 py-2 px-6 shadow-lg z-20">SOLICITA COTIZACIÓN</button>
                  <form className="hidden flex flex-wrap gap-3 w-full p-5 bg-white rounded-lg">
      ...
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                ...
                <input type="text" className="
                  ...
                  " placeholder=""/>
                    ...
                    <button type="submit" className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg z-20">Get Sources</button>
                  </form> */}

                </div>

                <div className="mt-2 w-3/5 xs:w-4/5 xl:w-1/3 md:w-3/5 text-center md:ml-auto 2xl:py-7 z-30">
                  <img className="w-full  md:w-4/5  " src={smartSVG} />
                </div>
            ...
            {/* <div className="relative -mt-12 lg:-mt-24">
              <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www3.org/2000/svg">
            ...
            {/* Alternate features */}
            <section id="servicios" className="border-b 2xl:py-16 xl:py-16 xs:py-32 py-20  bg-white">
